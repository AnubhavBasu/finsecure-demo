...
3.2. Transfers above $2,000 require secondary approval via a step-up OTP challenge, sent to the customer's registered mobile number, before the transfer is submitted for processing.
...
3.4. **Update (August 2026):** Payments to previously saved, verified payees are processed instantly without additional verification, provided the sending account is not in Restricted status.

3.5. The system should notify the customer of any suspicious transaction activity on their account.
